...
public class JwtUtils {
    ...
    public JwtUtils(RefreshTokenRepository refreshTokenRepository, UsuarioRepository userRepository) {
    ...
    public ResponseCookie cleanRefreshToken(Usuario user){
    ...
    public String generateRefreshToken(String email) {
        ...
        Usuario user = userRepository.findByCorreo(email).orElse(null);
